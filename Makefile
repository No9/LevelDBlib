...
CFLAGS += -I. -I./node-leveldown/deps/leveldb/leveldb-1.11.0/include $(PLATFORM_CCFLAGS) $(OPT)
CXXFLAGS += -I. -I./node-leveldown/deps/leveldb/leveldb-1.11.0/include $(PLATFORM_CXXFLAGS) $(OPT)
